...
public class ApiGatewayAuthentication {
	...
	public SecurityWebFilterChain filterChain(ServerHttpSecurity http, ServerAuthenticationEntryPoint authenticationEntryPoint,  CustomAccessDeniedHandler accessDeniedHandler) throws Exception {
		http.csrf().disable().authorizeExchange()
				...
				.pathMatchers("/users/{email}").hasAnyRole("ADMIN", "OWNER")
				...
				.pathMatchers("/bank-account/update-balance/from/{from}/to/{to}/quantity/{quantity}/user/{email}").hasRole("USER")
				.pathMatchers("/bank-account/update-balance-trade/from/{from}/to/{to}/quantity/{quantity}/user/{email}").hasRole("USER")
				.pathMatchers("/bank-account/update-balance-transfer/user/{email}/quantity/{quantity}/from/{currency}/add-subtract/{add_subtract}").hasRole("USER")
				...
				.pathMatchers("/crypto-wallet/update-balance/from/{from}/to/{to}/quantity/{quantity}/user/{email}").hasRole("USER")
				.pathMatchers("/crypto-wallet/update-balance-trade/from/{from}/to/{to}/quantity/{quantity}/user/{email}").hasRole("USER")
				.pathMatchers("/crypto-wallet/update-balance-transfer/user/{email}/quantity/{quantity}/from/{currency}/add-subtract/{add_subtract}").hasRole("USER")
